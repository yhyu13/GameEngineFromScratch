...
//optionally: cl /EHsc -I./DirectXMath helloengine_d3d12.cpp user32.lib d3d12.lib d3dcompiler.lib dxgi.lib gdi32.lib
...
const uint32_t nScreenWidth    =  1280;
                   ...
                   int nCmdShow)
{
    ...
    DWORD Style = WS_OVERLAPPEDWINDOW; //WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_THICKFRAME | WS_MINIMIZEBOX | WS_MAXIMIZEBOX
    RECT desktop;
    RECT wnd = {0,0,nScreenWidth,nScreenHeight};
...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        // Step 1:
        // hFont = CreateFont(50, 0, 0, 0, 0, false, false, false, DEFAULT_CHARSET,
        //             OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, (LPCSTR)"Arial");
        // if ( !hFont )
        // {
